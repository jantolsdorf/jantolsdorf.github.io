const ICON_ACTION_SETTINGS = "Configuració";
...
const ICON_GENERATE_SHORTCUT = "Crear enllaç";
const ICON_GROUP_2 = "Agrupar";
const ICON_HIDE = "Ocultar";
const ICON_IPAD = "Tauleta";
const ICON_IPHONE = "Telèfon";
const ICON_LAPTOP = "Ordinador portàtil";
const ICON_MESSAGE_ERROR = "Error";
const ICON_MESSAGE_INFORMATION = "Informació";
const ICON_MESSAGE_SUCCESS = "Correct.";
const ICON_MESSAGE_WARNING = "Advertència";
const ICON_MOVE = "Desplaçar";
const ICON_MULTI_SELECT = "Selecció múltiple";
const ICON_NAV_BACK = "Endarrere";
const ICON_OVERFLOW = "Més";
...
const ICON_SETTINGS = "Configuració";
