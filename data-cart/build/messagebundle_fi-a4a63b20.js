...
const ICON_ADD = "Lisää";
const ICON_ADD_CONTACT = "Lisää yhteyshenkilöt";
const ICON_ADD_FILTER = "Lisää suodatin";
const ICON_ADD_PHOTO = "Lisää kuva";
const ICON_BACK_TO_TOP = "Alkuun";
const ICON_COLLAPSE = "Tiivistä";
const ICON_COLLAPSE_GROUP = "Tiivistä ryhmä";
const ICON_CROP = "Rajaa";
const ICON_DECLINE = "Hylkää";
const ICON_DELETE = "Poista";
const ICON_DISPLAY = "Näytä";
const ICON_DOWN = "Alas";
const ICON_DOWNLOAD = "Lataa paikallisesti";
const ICON_DRILL_DOWN = "Siirry alas";
const ICON_DRILL_UP = "Siirry ylös";
const ICON_ERROR = "Virhe";
const ICON_EXIT_FULL_SCREEN = "Lopeta kokonäyttötila";
const ICON_EXPAND = "Laajenna";
const ICON_EXPAND_GROUP = "Laajenna ryhmä";
const ICON_FILTER = "Suodatin";
const ICON_FLAG = "Valitse";
const ICON_FORWARD = "Eteenpäin";
const ICON_FULL_SCREEN = "Aktivoi kokonäyttötila";
const ICON_GENERATE_SHORTCUT = "Luo yhteys";
const ICON_GROUP_2 = "Ryhmä";
