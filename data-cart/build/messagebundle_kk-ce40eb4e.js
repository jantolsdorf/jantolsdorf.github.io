...
const MESSAGE_STRIP_CLOSE_BUTTON = "Күй хабарының жолын жабу";
...
const SEGMENTEDBUTTON_ARIA_DESCRIPTION = "Сегменттелген түйме";
const SLIDER_ARIA_DESCRIPTION = "Жүгірткі";
const SWITCH_ON = "Қосулы";
const SWITCH_OFF = "Өш.";
...
export default messagebundle_kk;
