...
const BUTTON_ARIA_TYPE_EMPHASIZED = "Emphasised";
...
const COLORPALETTE_CONTAINER_LABEL = "Colour Palette - Predefined Colours";
const COLORPALETTE_COLOR_LABEL = "Colour";
const COLOR_PALETTE_DIALOG_CANCEL_BUTTON = "Cancel";
const COLOR_PALETTE_DIALOG_OK_BUTTON = "OK";
const COLOR_PALETTE_DIALOG_TITLE = "Change Colour";
const COLOR_PALETTE_MORE_COLORS_TEXT = "More Colours...";
...
const LINK_EMPHASIZED = "Emphasised";
...
const TOKENIZER_ARIA_LABEL = "Tokeniser";
...
export default messagebundle_en_GB;
