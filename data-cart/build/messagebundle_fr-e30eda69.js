...
const ARIA_ROLEDESCRIPTION_CARD_HEADER = "En-tête carte";
const ARIA_ROLEDESCRIPTION_INTERACTIVE_CARD_HEADER = "En-tête de carte interactive";
...
const CAROUSEL_DOT_TEXT = "Élément {0}/{1} affiché";
...
const DATEPICKER_OPEN_ICON_TITLE = "Ouvrir sélecteur";
...
const SELECT_OPTIONS = "Sélectionner options";
...
const INPUT_SUGGESTIONS_MORE_HITS = "{0} résultats sont disponibles.";
const INPUT_SUGGESTIONS_NO_HIT = "Aucun résultat";
const LINK_SUBTLE = "Subtil";
const LINK_EMPHASIZED = "Mis en surbrillance";
const LIST_ITEM_POSITION = "Élément de liste {0}/{1}";
const LIST_ITEM_SELECTED = "Sélectionné";
const ARIA_LABEL_LIST_ITEM_CHECKBOX = "Mode sélection multiple";
const MESSAGE_STRIP_CLOSE_BUTTON = "Fermer barre de message";
...
const RATING_INDICATOR_TEXT = "Étoiles d'évaluation";
const RESPONSIVE_POPOVER_CLOSE_DIALOG_BUTTON = "Refuser";
const SEGMENTEDBUTTON_ARIA_DESCRIPTION = "Bouton segmenté";
const SLIDER_ARIA_DESCRIPTION = "Poignée du curseur";
const SWITCH_ON = "Act.";
const SWITCH_OFF = "Dés.";
...
const TOKENIZER_ARIA_LABEL = "Générateur de jetons";
const TOKENIZER_POPOVER_REMOVE = "Supprimer";
const TREE_ITEM_ARIA_LABEL = "Élément d'arborescence";
const TREE_ITEM_EXPAND_NODE = "Développer noeud";
const TREE_ITEM_COLLAPSE_NODE = "Réduire noeud";
const VALUE_STATE_ERROR = "Entrée non valide";
const VALUE_STATE_WARNING = "Avertissement édité";
const VALUE_STATE_INFORMATION = "Entrée pour information";
const VALUE_STATE_SUCCESS = "Entrée validée correctement";
...
export default messagebundle_fr;
