const ARIA_LABEL_CARD_CONTENT = "Contenido de la tarjeta";
const ARIA_ROLEDESCRIPTION_CARD = "Tarjeta";
const ARIA_ROLEDESCRIPTION_CARD_HEADER = "Encabezado de tarjeta";
const ARIA_ROLEDESCRIPTION_INTERACTIVE_CARD_HEADER = "Encabezado de tarjeta interactivo";
const AVATAR_TOOLTIP = "Avatar";
const BADGE_DESCRIPTION = "Insignia";
...
const CAROUSEL_DOT_TEXT = "Elemento {0} de {1} mostrado";
...
const COLOR_PALETTE_DIALOG_TITLE = "Cambiar color";
...
const DELETE = "Borrar";
const FILEUPLOAD_BROWSE = "Explorar...";
const FILEUPLOADER_TITLE = "Cargar archivo";
const GROUP_HEADER_TEXT = "Encabezado de grupo";
const SELECT_OPTIONS = "Seleccionar opciones";
const INPUT_SUGGESTIONS = "Sugerencias disponibles";
const INPUT_SUGGESTIONS_TITLE = "Seleccionar";
const INPUT_SUGGESTIONS_ONE_HIT = "1 resultado disponible";
const INPUT_SUGGESTIONS_MORE_HITS = "{0} resultados disponibles";
const INPUT_SUGGESTIONS_NO_HIT = "Ningún resultado";
const LINK_SUBTLE = "Sutil";
const LINK_EMPHASIZED = "Resaltado";
const LIST_ITEM_POSITION = "Elemento de lista {0} de {1}";
const LIST_ITEM_SELECTED = "Seleccionado";
const ARIA_LABEL_LIST_ITEM_CHECKBOX = "Modo de selección múltiple";
const MESSAGE_STRIP_CLOSE_BUTTON = "Cierre de franja de mensajes";
const MULTICOMBOBOX_DIALOG_OK_BUTTON = "OK";
const MULTIINPUT_ROLEDESCRIPTION_TEXT = "Entrada de valores múltiples";
const MULTIINPUT_SHOW_MORE_TOKENS = "{0} más";
const PANEL_ICON = "Expandir/contraer";
const RANGE_SLIDER_ARIA_DESCRIPTION = "Intervalo";
const RANGE_SLIDER_START_HANDLE_DESCRIPTION = "Control izquierdo";
const RANGE_SLIDER_END_HANDLE_DESCRIPTION = "Control derecho";
const RATING_INDICATOR_TOOLTIP_TEXT = "Clasificación";
const RATING_INDICATOR_TEXT = "Indicador de clasificación";
const RESPONSIVE_POPOVER_CLOSE_DIALOG_BUTTON = "Rechazar";
const SEGMENTEDBUTTON_ARIA_DESCRIPTION = "Botón segmentado";
const SLIDER_ARIA_DESCRIPTION = "Control deslizante";
const SWITCH_ON = "Activar";
const SWITCH_OFF = "Desactivar";
...
const TEXTAREA_CHARACTERS_LEFT = "Quedan {0} caracteres";
const TEXTAREA_CHARACTERS_EXCEEDED = "{0} caracteres por encima del límite";
...
const TOKEN_ARIA_DELETABLE = "Eliminable";
...
const TOKENIZER_POPOVER_REMOVE = "Quitar";
const TREE_ITEM_ARIA_LABEL = "Elemento de árbol";
const TREE_ITEM_EXPAND_NODE = "Expandir nodo";
const TREE_ITEM_COLLAPSE_NODE = "Contraer nodo";
...
const STEPINPUT_DEC_ICON_TITLE = "Disminuir";
const STEPINPUT_INC_ICON_TITLE = "Aumentar";
const messagebundle_es_MX = {
...
export default messagebundle_es_MX;
