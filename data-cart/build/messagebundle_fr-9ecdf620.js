...
const ICON_BACK_TO_TOP = "Au départ";
const ICON_COLLAPSE = "Réduire";
const ICON_COLLAPSE_GROUP = "Réduire groupe";
...
const ICON_EXPAND_GROUP = "Développer groupe";
const ICON_FILTER = "Filtrer";
const ICON_FLAG = "Sélectionner";
const ICON_FORWARD = "Transférer";
const ICON_FULL_SCREEN = "Activer mode plein écran";
const ICON_GENERATE_SHORTCUT = "Créer relation";
...
const ICON_NAV_BACK = "Naviguer en arrière";
const ICON_OVERFLOW = "Plus";
const ICON_REDO = "Répéter";
const ICON_REFRESH = "Mettre à jour";
...
const ICON_SORT_DESCENDING = "Trier par ordre décroissant";
