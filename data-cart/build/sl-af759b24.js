...
const territories = {
	...
	MN: "Mongolija",
	MO: "Macao",
	"MO-alt-short": "Posebno administrativno območje LR Kitajske Macao",
...
const units = {
	short: {
		...
		"area-dunam": {
			...
			"unitPattern-count-two": "{0} dunama",
			"unitPattern-count-few": "{0} dunami",
			"unitPattern-count-other": "{0} dunamov"
		},
		"concentr-karat": {
			displayName: "kt",
