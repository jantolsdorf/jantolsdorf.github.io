...
const ICON_ADD_CONTACT = "Pridať kontaktnú osobu";
...
const ICON_IPHONE = "Telefón";
const ICON_LAPTOP = "Laptop";
const ICON_MESSAGE_ERROR = "Chyba";
const ICON_MESSAGE_INFORMATION = "Informácia";
const ICON_MESSAGE_SUCCESS = "Úspešne";
const ICON_MESSAGE_WARNING = "Upozornenie";
const ICON_MOVE = "Premiestniť";
const ICON_MULTI_SELECT = "Viacnásobný výber";
const ICON_NAV_BACK = "Prejsť späť";
