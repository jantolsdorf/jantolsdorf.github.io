...
const ICON_ACTIVATE = "Aktivér";
const ICON_ADD = "Tilføj";
const ICON_ADD_CONTACT = "Tilføj kontaktperson";
const ICON_ADD_FILTER = "Tilføj filter";
const ICON_ADD_PHOTO = "Tilføj foto";
const ICON_BACK_TO_TOP = "Til start";
const ICON_COLLAPSE = "Komprimer";
const ICON_COLLAPSE_GROUP = "Komprimer gruppe";
const ICON_CROP = "Beskær";
...
const ICON_DRILL_UP = "Vis færre detaljer";
const ICON_ERROR = "Fejl";
const ICON_EXIT_FULL_SCREEN = "Afslut fuldskærmmode";
...
const ICON_FULL_SCREEN = "Aktiver fuldskærmmode";
const ICON_GENERATE_SHORTCUT = "Opret relation";
const ICON_GROUP_2 = "Gruppér";
...
const ICON_RESIZE = "Ændr størrelse";
const ICON_RESIZE_HORIZONTAL = "Ændr størrelse horisontalt";
const ICON_RESIZE_VERTICAL = "Ændr størrelse vertikalt";
const ICON_RESPONSE = "Svar";
const ICON_SAVE = "Gem";
const ICON_SEARCH = "Søg";
