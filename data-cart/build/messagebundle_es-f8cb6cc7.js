...
const ICON_ADD = "Añadir";
const ICON_ADD_CONTACT = "Añadir persona contacto";
const ICON_ADD_FILTER = "Añadir filtro";
const ICON_ADD_PHOTO = "Añadir foto";
...
const ICON_IPHONE = "Teléfono";
const ICON_LAPTOP = "Portátil";
const ICON_MESSAGE_ERROR = "Error";
const ICON_MESSAGE_INFORMATION = "Información";
const ICON_MESSAGE_SUCCESS = "Con éxito";
const ICON_MESSAGE_WARNING = "Advertencia";
const ICON_MOVE = "Desplazar";
const ICON_MULTI_SELECT = "Selección múltiple";
const ICON_NAV_BACK = "Navegar atrás";
const ICON_OVERFLOW = "Más";
const ICON_REDO = "Repetir";
const ICON_REFRESH = "Actualizar";
const ICON_RESIZE = "Modificar tamaño";
const ICON_RESIZE_HORIZONTAL = "Modificar tamaño horizontalmente";
const ICON_RESIZE_VERTICAL = "Modificar tamaño verticalmente";
